...
// Ensure the correct order of values
db.query(
  insertApplicationFormQuery,
  [
    formData.application_type, // Ensure this maps to application_type
    formData.roll_number, // Ensure this maps to roll_number
    formData.full_name,
  ...
  (err, result) => {
    ...
    const applicationNumber = result.insertId; // Auto-generated application number
